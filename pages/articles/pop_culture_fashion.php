    ...
    <div class="pop_culture_container">
        ...
        <div class="pop_culture_header_container">
            <div class="pop_culture_header_left_container">
                ...
                <video src="/video/fashion_pop_culture.mp4" autoplay loop muted width="100%">
            </div>
            <img src="<?= $imagesParts[0] ?>" alt="" class="pop_culture_header_right_img">
        </div>
        <div class="pop_culture_thirteenth_container">
            ...
            <img src="<?= $imagesParts[3] ?>" alt="" class="pop_culture_thirteenth_right_img">
        </div>
        <div class="pop_culture_simpson_container">
            <img src="<?= $imagesParts[4] ?>" alt="" class="pop_culture_simpson_img">
        ...
        <div class="pop_culture_last_container">
            <?php foreach (array_slice($imagesParts, 9, 2) as $part) : ?>
                <img src="<?= $part ?>" alt="">
            <?php endforeach ?>
